...
WheelPicker.prototype = {
    ...
    _createDOM: function() {
        ...
        this.container.innerHTML = "<div class='wheelpicker-backdrop'></div><div class='wheelpicker-panel'><div class='wheelpicker-bilbilak'></div><div class='wheelpicker-actions'><button type='button' class='btn-cancel'>بستن</button><button type='button' class='btn-set'>ثبت</button><h4 class='wheelpicker-title'></h4></div><div class='wheelpicker-main'><div class='wheelpicker-wheels'></div><div class='wheelpicker-mask wheelpicker-mask-top'></div><div class='wheelpicker-mask wheelpicker-mask-current'></div><div class='wheelpicker-mask wheelpicker-mask-btm'></div></div></div>";
    ...
    _bindEvents: function() {
        ...
        this.container.querySelector(".wheelpicker-bilbilak").addEventListener("click", this._cancel.bind(this));
        this.container.querySelector(".wheelpicker-backdrop").addEventListener("click", this._cancel.bind(this));
